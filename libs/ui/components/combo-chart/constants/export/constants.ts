...
export const KRUI_CHART_AXIS_HEIGHT = 20;
export const KRUI_CHART_AXIS_OFFSET = 8;

export const KRUI_CHART_DEFAULT_WIDTH = 800;
export const KRUI_CHART_DEFAULT_HEIGHT = 600;

export const KRUI_CHART_DEFAULT_TOOLBAR_HEIGHT = 18;
export const KRUI_CHART_DEFAULT_LEGEND_HEIGHT = 18;
